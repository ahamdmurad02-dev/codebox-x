...
## CodeBox X v1.2.1 — Active File Execution Update
...
The v1.2.1 update passed a full Windows Release build with **0 warnings and 0 errors**. The active-file verification suite successfully executed Python and C# active files with the installed Python 3.12 and .NET SDK. C++ and GDScript active-run support were removed by product direction and are not advertised as executable workflows.
